...
import { WIREFRAME_TEMPLATES, WIREFRAME_VIEWBOX } from "@/modules/torres-vistoria/domain/photos/wireframe-templates";
import type { WireframeHighlight, WireframeView } from "@/modules/torres-vistoria/domain/photos/types";
