import { ILLUSTRATION_TOKENS } from "@/modules/torres-vistoria/domain/photos/illustrations/tokens";
import {
  getIllustration,
  getIllustrationPart,
} from "@/modules/torres-vistoria/domain/photos/illustrations/catalog";
