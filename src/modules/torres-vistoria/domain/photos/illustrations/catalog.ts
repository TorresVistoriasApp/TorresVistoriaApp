...
} from "@/modules/torres-vistoria/domain/photos/illustrations/types";
import { damageDetail } from "@/modules/torres-vistoria/domain/photos/illustrations/views/damage-detail";
import { documentSheet } from "@/modules/torres-vistoria/domain/photos/illustrations/views/document-sheet";
import { doorStructure } from "@/modules/torres-vistoria/domain/photos/illustrations/views/door-structure";
import { engineCompartment } from "@/modules/torres-vistoria/domain/photos/illustrations/views/engine-compartment";
import { identificationPlate } from "@/modules/torres-vistoria/domain/photos/illustrations/views/identification-plate";
import { interiorCabin } from "@/modules/torres-vistoria/domain/photos/illustrations/views/interior-cabin";
import { pillarStructure } from "@/modules/torres-vistoria/domain/photos/illustrations/views/pillar-structure";
import { safetyEquipment } from "@/modules/torres-vistoria/domain/photos/illustrations/views/safety-equipment";
import { trunkCompartment } from "@/modules/torres-vistoria/domain/photos/illustrations/views/trunk-compartment";
import { vehicleFront } from "@/modules/torres-vistoria/domain/photos/illustrations/views/vehicle-exterior-front";
import { vehicleRear } from "@/modules/torres-vistoria/domain/photos/illustrations/views/vehicle-exterior-rear";
import { vehicleSideLeft } from "@/modules/torres-vistoria/domain/photos/illustrations/views/vehicle-exterior-side";
import { vehicleTop } from "@/modules/torres-vistoria/domain/photos/illustrations/views/vehicle-exterior-top";
import { wheelAssembly } from "@/modules/torres-vistoria/domain/photos/illustrations/views/wheel-assembly";
import { windshieldGlass } from "@/modules/torres-vistoria/domain/photos/illustrations/views/windshield-glass";
