import { defineIllustration } from "@/modules/torres-vistoria/domain/photos/illustrations/tokens";
import { SEDAN_FRONT_BODY } from "@/modules/torres-vistoria/domain/photos/illustrations/silhouette-paths";
