import { z } from "zod";
import { clienteSchema } from "@/modules/torres-vistoria/schemas/cliente";
import { veiculoSchema } from "@/modules/torres-vistoria/schemas/veiculo";
import { InspectionOpinion, InspectionStatus } from "@/modules/torres-vistoria/domain/enums";
import { FIELD_NA_VALUE } from "@/shared/lib/field-na";
import { parseCurrency } from "@/shared/lib/masks";
import {
  isPlaceholderDraftValue,
  WIZARD_REQUIRED_DRAFT_FIELDS,
} from "@/modules/torres-vistoria/draft/lib/draft-defaults";
