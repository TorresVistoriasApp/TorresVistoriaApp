...
/**
 * Rótulos, cores e resumos legíveis dos registros de auditoria.
 *
 * Fica no módulo de administração porque descreve entidades de produto
 * (vistoria, laudo, checklist) — conhecimento que o núcleo não deve carregar.
 */
