...
import { FileSearch, Home, Plus, User } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: ROUTES.consultaAppMinhaConta, label: "Conta", icon: User, match: "exact" as const },
] as const;
            ...
            >
              <span
                className={cn(
                  ...
                  active && "bg-primary/10 shadow-[inset_0_0_0_1px_rgb(234_88_12_/_0.12)]",
                )}
              >
