...
import { SyncStatusIndicator } from "@/modules/torres-vistoria/draft/components/sync-status-indicator";
import { useSyncStatus } from "@/modules/torres-vistoria/draft/hooks/use-offline-sync";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
