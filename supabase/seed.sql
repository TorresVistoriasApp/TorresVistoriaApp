...
INSERT INTO public.permissions (code, name, description) VALUES
  ...
  ('settings.company.identity', 'Dados cadastrais do laudo', 'Alterar CPF/CNPJ, identificação e endereço impressos no laudo em PDF'),
...
JOIN public.permissions p ON p.code IN ('inspections.create','inspections.read.own','inspections.update.own','reports.export','financial.read.own','settings.company.identity','consulta.create','consulta.read.own')
